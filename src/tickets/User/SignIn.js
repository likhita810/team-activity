    ...
    render() {
        return(
            <div className="userSignin">
                <h1 className="uH1">Please Sign In here!</h1>
                <form className="uForm">
                    <div className="uFormDiv">
                    <p>User name:</p> 
                    ...
                    <div className="uFormDiv">
                    <p>Number:</p> 
                    <input type="text" onBlur={(e) => this.handleValidation(e, 'Number')}></input>
                    <p style={{color: 'red'}}>{this.state.roleErr}</p>
                    </div>

                    <div className="uFormDiv">
                    <p>Password:</p> 
                    <input type="password" onBlur={(e) => this.handleValidation(e, 'password')}></input>
                    <p style={{color: 'red'}}>{this.state.pswdErr}</p>
                    </div>

                    <div className="uFormDiv">
                    <p>Confirm Password:</p> 
                    <input type="password" onBlur={(e) => this.handleValidation(e, 'confirmPassword')}></input>
                    <p style={{color: 'red'}}>{this.state.pswdErr}</p>
                    </div>

                    <div className="uFormDiv">
                    <p style={{color: 'red'}}>{this.state.err}</p>
                    <button  className="uSubmit" onClick={(e) => this.handleSubmit(e)}>Submit</button>
                    </div>
                </form>
            </div>
        )
